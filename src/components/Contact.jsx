...
const contacts = [
  {
    ...
    label: "Email",
    value: "jeontaesu@gmail.com",
    href: "mailto:jeontaesu@gmail.com"
  },
  {
    icon: (
...
function ContactCard({ contact, index }) {
  ...
  return (
    <a
      ref={ref}
      href={contact.href}
      className={`group rounded-2xl border border-t-border bg-t-card p-6 text-center transition-all duration-700 ease-out hover:-translate-y-1 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 ${
    ...
    >
      ...
      <p className="mb-1 text-sm font-semibold text-t-heading">{contact.label}</p>
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-t-card/30 px-4 py-24 md:px-8 md:py-32 lg:px-16">
      <div className="mx-auto max-w-3xl">
        ...
        >
          <p className="mb-3 text-sm font-medium tracking-widest text-primary uppercase">Contact</p>
          <h2 className="mb-4 text-3xl font-bold text-t-heading md:text-4xl">연락처</h2>
          <p className="mx-auto max-w-2xl text-t-text">프로젝트 협업이나 문의사항이 있으시면 편하게 연락해 주세요.</p>
        </div>
